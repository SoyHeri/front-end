...
import {dataHombre} from'../../DB/dataHombre'
import { Link } from 'react-router-dom';

//import ProductButton from '../../Components/AddCart/ProductButton'
//import { Link } from 'react-router-dom';
                  ...
                  <div className="card">
                    ...
                    <div className="card-body">
                      <div className="d-flex justify-content-between">
                        <p className="small"><Link to="#!" className="text-muted"></Link></p>
                        <p className="small text-danger"><s>${data.precio + 100}</s></p>
                      </div>
    
                      <div className="d-flex justify-content-between mb-3">
                        <h8 className="mb-0">{data.nombre}</h8>
